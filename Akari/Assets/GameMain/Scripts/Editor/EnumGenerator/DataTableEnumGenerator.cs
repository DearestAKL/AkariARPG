...
using UnityEditor;
using GameFramework;
using Akari.Editor.DataTableTools;
...
namespace Akari.Editor
{
    public static class DataTableEnumGenerator
    {
        ...
        private readonly static string GeneratePath = "Assets/GameMain/Scripts/Runtime/Definition/Enum/GenerateEnum";
        ...
        [MenuItem("Game Framework/Akari/Generate DataTable Enum", false, 1)]
