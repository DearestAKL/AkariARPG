...
namespace Akari.HUD
{
    ...
    public class AtlasMng_Editor : CAtlasMng
    {
        ...
        private const string assetsTxtPath = "/GameMain/Atlas/assets_all.txt";
        private const string assetsBytesPath = "/GameMain/Atlas/assets_all.bytes";
        ...
        void Reload()
        {
            string szCfgPathName = Application.dataPath + assetsTxtPath;
        ...
        public void LoadAndSaveAtlas(bool bLoadFromTxt)
        {
            ...
            {
                string szCfgPathName = Application.dataPath + assetsBytesPath;
                if (File.Exists(szCfgPathName))
                {
        ...
        public override void SaveAltasCfg()
        {
            if (IsCanSave())
            {
                ...
                SerializeToTxt(ar);
                ar.Close();
                string szBinPathName = Application.dataPath + assetsBytesPath;
        ...
        protected override bool QueryAltasTex(UITexAtlas atlas, UITexAtlas.OnLoadAtlas lpOnLoadFunc)
        {
            if (IsEditorMode())
            {
                string szTxtAssetPath = "Assets/GameMain/Atlas/" + atlas.m_szAtlasName + ".png";
                Texture tex = AssetDatabase.LoadAssetAtPath(szTxtAssetPath, typeof(Texture)) as Texture;
                if (atlas.m_material == null)
                {
                    string szShaderName = atlas.m_szShaderName;
                    bool bHaveMainAlpha = atlas.m_szShaderName == "HUD/Transparent Colored MainAlpha";
                    ...
                    if (shader == null)
                    {
                        shader = Shader.Find("HUD/Transparent Colored");
                    }
                    atlas.m_material = new Material(shader);
                    atlas.m_material.name = atlas.m_szAtlasName;
                    if (bHaveMainAlpha)
                    {
                        szTxtAssetPath = "Assets/GameMain/Atlas/" + atlas.m_szAtlasName + "_alpha.png";
        ...
        bool NewAtlas(string szAtlasName, string szShaderName, bool bCanLOD)
        {
            ...
            atlas.m_material = new Material(shader);
            atlas.m_szShaderName = szShaderName;// bAtlasPMA ? "HUD/Premultiplied Colored" : "HUD/Transparent Colored";
        ...
        public bool AddOrUpdateSelectSprite(List<SUpdateTexInfo> nameList, bool bTrimAlpha, bool bAtlasPMA, bool bCanLOD)
        {
            ...
            string szShaderName = bAtlasPMA ? "HUD/Premultiplied Colored" : "HUD/Transparent Colored MainAlpha";
        ...
        bool UpdateAltasBySelect(ref List<SelecctTexInfo> aSelectTex, string szAtlasName, bool bTrimAlpha, ref bool bReplace)
        {
            ...
            string szAtlasPathName = "Assets/GameMain/Atlas/" + szAtlasName + ".png";
